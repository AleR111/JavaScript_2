    ...
    template: `
        <div>
            <section class="description">
                <description__carousel></description__carousel>
                <description__border></description__border>
            </section>
    ...
    template: `
        <div class="description__carousel">
            ...
            <div class="description__carousel-box"> <a class="carousel__prev" href="#">
                ...
                <div class="description__img-box"><img src="img/carousel__img.jpg" alt="woman" class="description__img">
                </div>
        ...
        <div class="description__border">
            <div class="center">
                <div class="description__content">
                    <h4 class="headeng-mini description__heading-mini">WOMEN COLLECTION</h4>
                    <hr class="description__underline">
                    <h3 class="description__heading">MOSCHINO CHEAP AND CHIC</h3>
                    <p class="text description__text">Compellingly actualize fully researched processes before proactive
                        outsourcing.
                    ...
                    <p class="product__price description__price">$52.00
                    </p>
                    ...
                    <a class="button-cart description__cart" href="#">
